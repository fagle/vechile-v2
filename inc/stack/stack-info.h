...
typedef struct 
{
    int16u profileId;          // Identifies the endpoint's application profile. 
    int16u deviceId;           // The endpoint's device ID within the application profile. 
    int8u  deviceVersion;      // The endpoint's device version. 
...
typedef struct 
{
    int8u endpoint;                              // An endpoint of the application on this node. 
    EmberEndpointDescription PGM * description;  // The endpoint's description. 
    int16u PGM * inputClusterList;               // Input clusters the endpoint will accept. 
    int16u PGM * outputClusterList;              // Output clusters the endpoint may send. 
} EmberEndpoint;
