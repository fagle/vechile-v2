...
/** @brief DEPRECATED.  Use halMeasureVdd(ADC_SAMPLE_CLOCKS_512) instead.
 * Takes a slow ADC measurement of VDD_PADS in millivolts.  Due to
 * the conversions performed, this function takes slightly under 750us with a
...
/** @brief DEPRECATED.  Use halMeasureVdd(ADC_SAMPLE_CLOCKS_128) instead.
