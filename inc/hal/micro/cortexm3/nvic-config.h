...
// 0  - faults
// 4  - not used
// 8  - PendSV for deep sleep, SysTick for idling, MAC Tmr for idling during TX,
//        management interrupt for XTAL biasing..
// 12 - Priority level used by DISABLE_INTERRUPTS() and INTERRUPTS_OFF()
...
//INTENTIONALLY INDENTED AND SPACED APART! Keep it that way!  See comment above!
    ...
    SEGMENT()
    SEGMENT2()
    EXCEPTION(24, halStackMacTimerIsr,  8)      //MAC Timer Handler
