...
#if (EMBER_SERIAL1_MODE == EMBER_SERIAL_FIFO)
  // Max bytes used in software receive queue to prevent overflow when using RTS.
  // Need 2 free based on queue discipline, and 3 for the hardware FIFO
  #define SERIAL_RX1_QUEUE_HIGH_WATER (EMBER_SERIAL1_RX_QUEUE_SIZE - 5)
  #if SERIAL_RX1_QUEUE_HIGH_WATER <= 0
