 ...
 */
#define emberEventControlSetInactive(control)              ((control).status = EMBER_EVENT_INACTIVE)
...
/** @brief Sets this ::EmberEventControl to run at the next available
    opportunity.
 */
#define emberEventControlSetActive(control)                ((control).status = EMBER_EVENT_ZERO_DELAY)

/** @brief Sets this ::EmberEventControl to run "delay" milliseconds in the future.
 */
#define emberEventControlSetDelayMS(control, delay)        (emEventControlSetDelayMS(&control, (delay)))
 ...
 */
#define emberEventControlSetDelayQS(control, delay)        (emEventControlSetDelayQS(&control, (delay)))
 ...
 */
#define emberEventControlSetDelayMinutes(control, delay)   (emEventControlSetDelayMinutes(&control, (delay)))
