...
#define DATA_ANALOGUE_CONTROL_BASE                           (0x00000000u)
#define DATA_ANALOGUE_CONTROL_END                            (0x000000FFu)
#define DATA_ANALOGUE_CONTROL_SIZE                           (DATA_ANALOGUE_CONTROL_END - DATA_ANALOGUE_CONTROL_BASE + 1)
...
#define PA_RESET                                             (0x00000000u)
        ...
        /* UNUSED field */
        #define PA_UNUSED                                    (0x00004000u)
        #define PA_UNUSED_MASK                               (0x00004000u)
        #define PA_UNUSED_BIT                                (14)
        #define PA_UNUSED_BITS                               (1)
        /* PA_BIAS field */
...
#define IQMIXER_RESET                                        (0x00000000u)
        ...
        /* UNUSED field */
        #define IQMIXER_UNUSED                               (0x00006000u)
        #define IQMIXER_UNUSED_MASK                          (0x00006000u)
        #define IQMIXER_UNUSED_BIT                           (13)
        #define IQMIXER_UNUSED_BITS                          (2)
