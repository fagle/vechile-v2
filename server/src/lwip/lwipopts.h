...
#define MEM_ALIGNMENT           0x04    

/* MEM_SIZE: the size of the heap memory. If the application will send
a lot of data that needs to be copied, this should be set high. */
#define MEM_SIZE                (5 * 1024)  // (15*1024)//5K
...
/* TCP receive window. */
#define TCP_WND                 (2*TCP_MSS)//默认4*TCP_MSS

/**
 * TCP_MAXRTX: Maximum number of retransmissions of data segments.
 */
#define TCP_MAXRTX                      4//12

/**
 * TCP_SYNMAXRTX: Maximum number of retransmissions of SYN segments.
 */
#define TCP_SYNMAXRTX                   3//6
...
*/
//#define CHECKSUM_BY_HARDWARE 硬件checksums会ping不通
...
#define TCPIP_THREAD_PRIO               (configMAX_PRIORITIES - 0x01)
